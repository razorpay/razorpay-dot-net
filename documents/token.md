...
Dictionary<string, object> tokenRequest = new Dictionary<string, object>();
tokenRequest.Add("customer_id","cust_1Aa00000000001");
tokenRequest.Add("method","card");

Dictionary<string, object> card = new Dictionary<string, object>();
card.Add("number","4111111111111111");
card.Add("cvv","123");
card.Add("expiry_month","12");
card.Add("expiry_year","21");
card.Add("name","Gaurav Kumar");

tokenRequest.Add("card",card);

Dictionary<string, object> authentication = new Dictionary<string, object>();
authentication.Add("provider","razorpay");
